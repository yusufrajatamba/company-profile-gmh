...
import { History, Award, Users, Compass } from 'lucide-react';

export const SejarahSingkat: React.FC = () => {
  const milestones = [
    {
      year: '1998',
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="font-display font-bold text-3xl sm:text-4xl text-slate-900 tracking-wider uppercase leading-tight">
            Perjalanan Iman & Pelayanan Kami
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start mb-20">
          <div className="space-y-6 text-sm text-gray-700 leading-relaxed">
            <h3 className="font-display font-bold text-lg uppercase tracking-wider text-church-green">Berakar Pada Kerinduan Amanat Agung</h3>
            <p>
              Sejarah berdirinya <strong className="text-church-green">Global Mission House - PA KMK USU</strong> tidak lepas dari kerinduan mendalam dari para alumni pendahulu untuk melestarikan api rohani yang menyala selama masa kuliah. Setelah menyelesaikan studi, tantangan dunia profesional dan sekuler seringkali menguji iman para lulusan.
            </p>
            <p>
          ...
          <div className="space-y-6 text-sm text-gray-700 leading-relaxed border-l-2 border-church-gold/20 pl-6 md:pl-10">
            <h3 className="font-display font-bold text-lg uppercase tracking-wider text-church-green">Pusat Pengutusan dan Pembinaan</h3>
            <p>
              Gagasan menghadirkan <strong className="text-church-green">Global Mission House (GMH)</strong> timbul dari kebutuhan mendesak akan adanya pusat pelatihan fisik bagi para misionaris medis, guru pedalaman, dan relawan kemanusiaan. GMH juga difungsikan sebagai rumah pembinaan bagi mahasiswa Kristen aktif Universitas Sumatera Utara untuk memperlengkapi mereka sebelum diutus ke dunia kerja.
            </p>
            <p>
